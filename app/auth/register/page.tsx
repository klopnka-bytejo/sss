...
import { Gamepad2, Loader2, AlertCircle, User, Trophy, CheckCircle } from "lucide-react"
...
export default function RegisterPage() {
  ...
  const errors = {
    ...
    email: touched.email && !formData.email ? "Email is required" : 
           touched.email && formData.email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.email) ? "Please enter a valid email" : null,
    password: touched.password && !formData.password ? "Password is required" :
              touched.password && formData.password.length < 6 ? "Password must be at least 6 characters" : null,
    confirmPassword: touched.confirmPassword && !formData.confirmPassword ? "Please confirm your password" :
                     touched.confirmPassword && formData.password !== formData.confirmPassword ? "Passwords do not match" : null,
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 py-8">
      ...
      <Card className="w-full max-w-md glass relative z-10">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join the Elevate Gaming community</CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`bg-input ${errors.fullName ? "border-destructive focus-visible:ring-destructive" : ""}`}
              />
              {errors.fullName && (
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`bg-input ${errors.email ? "border-destructive focus-visible:ring-destructive" : ""}`}
              />
              {errors.email && (
                <p className="text-xs text-destructive flex items-center gap-1">
                  <AlertCircle className="h-3 w-3" />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`bg-input ${errors.password ? "border-destructive focus-visible:ring-destructive" : ""}`}
              />
              {errors.password && (
                <p className="text-xs text-destructive flex items-center gap-1">
                  <AlertCircle className="h-3 w-3" />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`bg-input ${errors.confirmPassword ? "border-destructive focus-visible:ring-destructive" : ""}`}
              />
